<?php
// coordinator/update_passwordcompany.php
...
if (isset($_POST['submit'])) {
    ...
    if (!verifyPassword($current, $user['password_hash'])) {
        ...
        logActivity($db, $user_id, 'PASSWORD_CHANGE', 'users', $user_id, 'Coordinator password changed');
...
<html>
<head>
    <title>Change Password - Coordinator</title>
    ...
    <style>
        ...
        .btn-update { background: #3498db; color: white; border: none; padding: 12px; border-radius: 25px; width: 100%; font-size: 16px; }
